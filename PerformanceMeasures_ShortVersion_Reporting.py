...
def CalculatePerformanceMeasuresReporting(IndividualID,walkforward_number,stock_number,dbObject):
    stringName= "performance_measures_"+"Reporting"+"_walk" + str(walkforward_number)+ "_" + "stock"+ str(gv.stock_number)
    resultPerformanceMeasures= dbObject.dbQuery("SELECT *, 1 FROM " + stringName)
